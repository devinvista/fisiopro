...
import { ClinicsTab, CouponsTab, FeatureMatrixTab, InadimplenciaTab, KpiCard, LimpezaTab, PainelTab, PaymentBadge, PaymentsTab, PlansTab, RegisterPaymentDialog, StatusBadge, SubscriptionsTab } from "./components";

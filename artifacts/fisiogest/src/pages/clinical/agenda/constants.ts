...
> = {
  agendado:   { label: "Agendado",   bg: "bg-emerald-500", text: "text-white", dot: "bg-emerald-300", border: "border-emerald-500", badge: "bg-emerald-100 text-emerald-800",   cardBg: "bg-emerald-500", cardSub: "text-white/80" },
  ...
  remarcado:  { label: "Remarcado",  bg: "bg-amber-400",   text: "text-white", dot: "bg-amber-300",   border: "border-amber-400",   badge: "bg-amber-100 text-amber-800",       cardBg: "bg-amber-400",   cardSub: "text-white/80" },
};

export const STATUS_FILTER_OPTIONS = [
  { value: "agendado",   label: "Agendado",   color: "#10b981" },
  ...
  { value: "remarcado",  label: "Remarcado",   color: "#f59e0b" },
] as const;

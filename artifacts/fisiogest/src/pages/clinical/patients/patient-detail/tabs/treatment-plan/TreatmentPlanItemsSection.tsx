      ...
      {planItems.length === 0 ? (
        ...
        <div className="space-y-2">
          {planItems.map((item) => {
            ...
            return (
              <div key={item.id} className={`group relative bg-white border ${isEditing ? 'border-primary shadow-sm' : 'border-slate-200 hover:border-slate-300'} rounded-xl p-3 transition-all`}>

...
export const WALLET_TX_LABELS: Record<string, { label: string; color: string; sign: "+" | "-" | "" }> = {
  ...
  credito:       { label: "Crédito",           color: "text-emerald-700 bg-emerald-50 border-emerald-200", sign: "+" },
  usoCarteira:   { label: "Uso Carteira",      color: "text-rose-700 bg-rose-50 border-rose-200",          sign: "-" },
  debito:        { label: "Débito Carteira",   color: "text-rose-700 bg-rose-50 border-rose-200",          sign: "-" },
  debitoServico: { label: "Débito de Serviço", color: "text-rose-700 bg-rose-50 border-rose-200",          sign: "-" },

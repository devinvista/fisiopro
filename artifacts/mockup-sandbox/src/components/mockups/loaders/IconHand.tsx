    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#f8fafc] text-[#1e3a5f] font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-32 h-32 mb-8 animate-float flex items-center justify-center">
          ...
          <div className="relative w-24 h-24 bg-white rounded-full shadow-lg shadow-teal-900/5 flex items-center justify-center border border-slate-100">
            <Hand className="w-10 h-10 text-[#0d9488] relative z-10 drop-shadow-sm" strokeWidth={2} />
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#10b981]/10 to-transparent"></div>
          </div>
        </div>

        <div className="text-center animate-fade-in-up">
          <p className="text-xs font-semibold text-[#0d9488] uppercase tracking-widest mb-2">Hand</p>
        ...
        <div className="w-48 h-1 bg-slate-200 rounded-full mt-8 overflow-hidden relative">
          <div className="absolute top-0 h-full bg-gradient-to-r from-[#0d9488] to-[#2563eb] rounded-full progress-bar"></div>
        </div>
      </div>
    </div>
  );

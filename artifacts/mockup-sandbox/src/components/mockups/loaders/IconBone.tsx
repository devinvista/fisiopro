    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#f8fafc] text-[#1e3a5f] font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="relative w-32 h-32 mb-8 animate-float flex items-center justify-center">
          <div className="absolute inset-0 rounded-full border-2 border-[#6366f1] opacity-0" style={{ animation: 'pulse-ring 2s cubic-bezier(0.215, 0.61, 0.355, 1) infinite' }}></div>
          ...
          <div className="relative w-24 h-24 bg-white rounded-full shadow-lg shadow-indigo-900/5 flex items-center justify-center border border-slate-100">
            <Bone className="w-10 h-10 text-[#6366f1] relative z-10 drop-shadow-sm spin-slow" strokeWidth={2} />
            <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#6366f1]/10 to-transparent"></div>
          </div>
        </div>

        <div className="text-center animate-fade-in-up">
          <p className="text-xs font-semibold text-[#6366f1] uppercase tracking-widest mb-2">Bone</p>
        ...
        <div className="w-48 h-1 bg-slate-200 rounded-full mt-8 overflow-hidden relative">
          <div className="absolute top-0 h-full bg-gradient-to-r from-[#6366f1] to-[#2563eb] rounded-full progress-bar"></div>
        </div>
      </div>
    </div>
  );
